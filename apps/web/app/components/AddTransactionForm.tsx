          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={`rounded-lg border px-3 py-2 text-sm ${
                kind === 'expense' ? 'bg-red-500 text-white border-red-500' : 'bg-white text-gray-700 border-gray-300'
              }`}
            >
              Expense
            </button>
            <button
              ...
              className={`rounded-lg border px-3 py-2 text-sm ${
                kind === 'income' ? 'bg-green-500 text-white border-green-500' : 'bg-white text-gray-700 border-gray-300'
              }`}
            >
              Income
            </button>
